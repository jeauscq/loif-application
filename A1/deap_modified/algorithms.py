...
from oned_gan import generate_individuals
...
def varAnd(population, toolbox, cxpb, mutpb):
    ...
    generated = generate_individuals(offspring)
    enhanced_offspring = []
    for i in generated:
        j = creator.Individuo(i)
        enhanced_offspring.append(j)
    ...
    enhanced_offspring = offspring + enhanced_offspring
...
def eaSimple(population, toolbox, cxpb, mutpb, ngen, stats=None,
    ...
    for gen in range(1, ngen + 1):
        ...
        population[:], n_synthetic = toolbox.select2(offspring)

        print(f"{n_synthetic} values were generated by the GAN")
