# Evolutive algorithms functions
...
def AG():
    """
    Runs a simple evolutory algorithm.
    """
    # Hyperparameters are defined
    generaciones = 15  # Number of generations
    tamañoPoblación = 75  # Population size
    ...
    popu, logbook = algorithms.eaSimple(popu, toolbox, cxpb=0.5,
                                        mutpb=mutation_gen, ngen=generaciones,
